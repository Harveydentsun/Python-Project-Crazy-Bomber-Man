...
HEROBATMANPATHS = [os.path.join(path1, path) for path in \
...
'''水果路径'''
FRUITPATHS = [os.path.join(path1, path) for path in \
    ['resources/images/misc/banana.png', 'resources/images/misc/cherry.png']]
'''背景路径'''
BACKGROUNDPATHS = [os.path.join(path1, path) for path in \
    ['resources/images/misc/bg0.png', 'resources/images/misc/bg1.png', 'resources/images/misc/bg2.png']]
'''爆炸和发射路径'''
BOMBPATH = os.path.join(path1, 'resources/images/misc/bomb.png')
FIREPATH = os.path.join(path1, 'resources/images/misc/fire.png')
'''背景音乐'''
BGMPATH = os.path.join(path1, 'resources/audio/bgm.mp3')
'''一些颜色'''
YELLOW = (255, 255, 0)
BLUE = (0, 0, 255)
RED = (255, 0, 0)
