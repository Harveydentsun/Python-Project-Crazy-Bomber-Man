...
class DQNetwork:
    def __init__(self, actions, input_shape,
        ...
        self.model.add(Conv2D(64, 5, strides=(2, 2),
                         padding='valid',
                         activation='relu',
    ...
    def train(self, batch, DQN_target):
        ...
        for datapoint in batch:
            ...
            x_train.append(datapoint['state'].astype(np.float64))
            ...
            t = list(self.predict(datapoint['state'])[0])
            if datapoint['final']:
                t[datapoint['action_index']] = datapoint['reward']
            else:
                t[datapoint['action_index']] = datapoint['reward'] + 0.5 * next_q_value
                # == datapoint['reward'] + self.discount_factor * next_q_value
            t_train.append(t)
